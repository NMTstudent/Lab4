...
В ходе данной лабораторной работы я узнал, что такое перцептрон, как он работае, почему разделяю машинное и глубокое обучение, что такое XOR и NAND
обучил перцептрон выполнять вычисления OR, AND, NAND, XOR, проанализировал его работу и оценил его возможности.
